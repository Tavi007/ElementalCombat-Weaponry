...
public class ItemList {
    ...
    public static final RegistryObject<Item> WOODEN_HALBERD = ITEMS.register("wooden_halberd",
        () -> new StyleSwitchingSword(ItemTier.WOOD, 5, -2.8F, halberdStyles, singleStack));
    public static final RegistryObject<Item> STONE_HALBERD = ITEMS.register("stone_halberd",
        () -> new StyleSwitchingSword(ItemTier.STONE, 5, -2.8F, halberdStyles, singleStack));
    public static final RegistryObject<Item> IRON_HALBERD = ITEMS.register("iron_halberd",
        () -> new StyleSwitchingSword(ItemTier.IRON, 5, -2.8F, halberdStyles, singleStack));
    ...
    public static final RegistryObject<Item> FIREANDICE_SWORD = ITEMS.register("fire_and_ice_sword",
        () -> new ElementSwitchingSword(ItemTier.IRON, 3, -2.4F, fireAndIce, singleStack));

    // armor
    // single pieces
    public static final RegistryObject<Item> SUNGLASSES = ITEMS.register("sunglasses",
        () -> new ArmorItem(ArmorMaterial.SUNGLASS, EquipmentSlotType.HEAD, singleStack));
    ...
    public static final RegistryObject<Item> WETSUIT_CHESTPLATE = ITEMS.register("wetsuit_chestplate",
        () -> new ArmorItem(ArmorMaterial.RUBBER, EquipmentSlotType.CHEST, singleStack));
    public static final RegistryObject<Item> DAYNIGHT_CHESTPLATE = ITEMS.register("daynight_chestplate",
        () -> new DayNightArmor(ArmorMaterial.CLOCK, EquipmentSlotType.CHEST, singleStack));

    public static final RegistryObject<Item> WETSUIT_LEGGINGS = ITEMS.register("wetsuit_leggings",
        () -> new ArmorItem(ArmorMaterial.RUBBER, EquipmentSlotType.LEGS, singleStack));
    public static final RegistryObject<Item> COOLING_LEGGINGS = ITEMS.register("cooling_leggings",
        () -> new ArmorItem(ArmorMaterial.IRON, EquipmentSlotType.LEGS, singleStack));

    public static final RegistryObject<Item> RUBBER_BOOTS = ITEMS.register("rubber_boots",
        () -> new ArmorItem(ArmorMaterial.RUBBER, EquipmentSlotType.FEET, singleStack));
    public static final RegistryObject<Item> HEAVY_BOOTS = ITEMS.register("heavy_boots",
        () -> new ArmorItem(ArmorMaterial.IRON, EquipmentSlotType.FEET, singleStack));

    // full sets
    public static final RegistryObject<Item> CREEPER_CHESTPLATE = ITEMS.register("creeper_chestplate",
        () -> new ArmorItem(ArmorMaterial.CREEPER, EquipmentSlotType.CHEST, singleStack));
    public static final RegistryObject<Item> CREEPER_LEGGINS = ITEMS.register("creeper_leggings",
        () -> new ArmorItem(ArmorMaterial.CREEPER, EquipmentSlotType.LEGS, singleStack));
    public static final RegistryObject<Item> CREEPER_BOOTS = ITEMS.register("creeper_boots",
        () -> new ArmorItem(ArmorMaterial.CREEPER, EquipmentSlotType.FEET, singleStack));

    public static final RegistryObject<Item> WOOL_HELMET = ITEMS.register("wool_helmet",
        () -> new ArmorItem(ArmorMaterial.WOOL, EquipmentSlotType.HEAD, singleStack));
    public static final RegistryObject<Item> WOOL_CHESTPLATE = ITEMS.register("wool_chestplate",
        () -> new ArmorItem(ArmorMaterial.WOOL, EquipmentSlotType.CHEST, singleStack));
    public static final RegistryObject<Item> WOOL_LEGGINS = ITEMS.register("wool_leggings",
        () -> new ArmorItem(ArmorMaterial.WOOL, EquipmentSlotType.LEGS, singleStack));
    public static final RegistryObject<Item> WOOL_BOOTS = ITEMS.register("wool_boots",
        () -> new ArmorItem(ArmorMaterial.WOOL, EquipmentSlotType.FEET, singleStack));

    public static final RegistryObject<Item> HIKING_HAT = ITEMS.register("hiking_hat",
        () -> new BiomeDependentArmor(ArmorMaterial.HIKING, EquipmentSlotType.HEAD, singleStack));
    public static final RegistryObject<Item> HIKING_VEST = ITEMS.register("hiking_vest",
        () -> new BiomeDependentArmor(ArmorMaterial.HIKING, EquipmentSlotType.CHEST, singleStack));
    public static final RegistryObject<Item> HIKING_SHORTS = ITEMS.register("hiking_shorts",
        () -> new BiomeDependentArmor(ArmorMaterial.HIKING, EquipmentSlotType.LEGS, singleStack));
    public static final RegistryObject<Item> HIKING_BOOTS = ITEMS.register("hiking_boots",
        () -> new BiomeDependentArmor(ArmorMaterial.HIKING, EquipmentSlotType.FEET, singleStack));

    public static final RegistryObject<Item> MIRROR_HELMET = ITEMS.register("mirror_helmet",
        () -> new MirrorArmor(ArmorMaterial.MIRROR, EquipmentSlotType.HEAD, singleStack));
    public static final RegistryObject<Item> MIRROR_CHESTPLATE = ITEMS.register("mirror_chestplate",
        () -> new MirrorArmor(ArmorMaterial.MIRROR, EquipmentSlotType.CHEST, singleStack));
    public static final RegistryObject<Item> MIRROR_LEGGINS = ITEMS.register("mirror_leggings",
        () -> new MirrorArmor(ArmorMaterial.MIRROR, EquipmentSlotType.LEGS, singleStack));
    public static final RegistryObject<Item> MIRROR_BOOTS = ITEMS.register("mirror_boots",
        () -> new MirrorArmor(ArmorMaterial.MIRROR, EquipmentSlotType.FEET, singleStack));
}
